      ...
      <div className="mt-6 grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
        <section className="overflow-hidden rounded-2xl border bg-white">
          <div className="flex items-center justify-between border-b px-6 py-5">
            ...
            <UserRoundPlus className="size-5 text-[#176b55]" />
          </div>
        ...
        <section className="overflow-hidden rounded-2xl border bg-white">
          ...
          <div className="divide-y">
            {customer.enquiries.map((enquiry) => (
              <Link key={enquiry.id} href={`/enquiries/${enquiry.id}`} className="block px-6 py-4 hover:bg-[#fafaf7]">
                <div className="flex items-center justify-between gap-3">
                  <p className="text-sm font-medium">{enquiry.reference}</p>
                  <span className="rounded-full bg-[#f1f3ef] px-2.5 py-1 text-[11px] capitalize text-[#68736e]">
