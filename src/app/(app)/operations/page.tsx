              ...
              <div className="space-y-6">
                <section>
                  <div className="flex items-center justify-between gap-3">
                    ...
                    {tour.status === "IN_PROGRESS" ? <span className="rounded-xl bg-[#f1f3ef] px-3 py-2 text-xs font-semibold text-[#68736e]">Readiness locked - tour started</span> : <form action={refreshTourReadinessAction}><input type="hidden" name="tourId" value={tour.id} /><button className="rounded-xl border px-3 py-2 text-xs font-semibold">Recalculate status</button></form>}
                  </div>
