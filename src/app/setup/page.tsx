...
export default async function SetupPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f3f4f6] px-6 py-12">
      <section className="w-full max-w-lg rounded-lg border bg-white p-7 shadow-sm sm:p-10">
        <div className="flex items-center gap-3 font-semibold">
          <span className="grid size-11 place-items-center rounded-lg bg-[#111827] text-white">
            <Compass className="size-5" />
          </span>
          Hineni Tour Operations
        </div>
        <p className="mt-10 text-xs font-semibold uppercase tracking-[0.2em] text-[#011478]">
